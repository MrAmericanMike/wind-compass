var FormatType = /* @__PURE__ */ ((FormatType2) => {
  FormatType2["LONG"] = "longFormat";
  FormatType2["SHORT"] = "shortFormat";
  return FormatType2;
})(FormatType || {});
...
const _WindCompass = class _WindCompass {
  /**
  ...
  constructor(longFormat, shortFormat) {
    __publicField(this, "LONG_FORMAT", {
      "N": "North",
    ...
    __publicField(this, "SHORT_FORMAT", {
      "N": "N",
      "NNE": "NNE",
      "NE": "NE",
      "ENE": "ENE",
  ...
  getWindFromDirection(degree, longFormat = true) {
    ...
    const DIRECTION = _WindCompass.DIRECTIONS.find((d) => {
...
__publicField(_WindCompass, "DIRECTIONS", [
